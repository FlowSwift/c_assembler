...
prod: main.c lines.o macros.o preprocessor.o util.o first_pass.o line_parser.o error_handler.o symbol_table.o binary_table.o binary_conversion.o $(BINDIR) $(OBJDIR)
	$(CC) $(CFLAGS) $(INCLUDE) main.c $(OBJDIR)/lines.o $(OBJDIR)/macros.o $(OBJDIR)/preprocessor.o $(OBJDIR)/util.o $(OBJDIR)/first_pass.o $(OBJDIR)/line_parser.o $(OBJDIR)/error_handler.o $(OBJDIR)/symbol_table.o $(OBJDIR)/binary_table.o $(OBJDIR)/binary_conversion.o -o $(BINDIR)/test.test
